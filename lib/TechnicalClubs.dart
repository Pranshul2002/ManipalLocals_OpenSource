...
class TechnicalClubs extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: TechnicalClubsData(),
      ),
    );
  }
}

class TechnicalClubsData extends StatefulWidget {
  @override
  _TechnicalClubsDataState createState() => _TechnicalClubsDataState();
}

class _TechnicalClubsDataState extends State<TechnicalClubsData> {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Expanded(
          child: StreamBuilder<DocumentSnapshot>(
              stream: Firestore.instance
                  .collection("TechnicalClubs")
                  .document("qvJafNU8X8unkOBrVbng")
                  .snapshots(),
